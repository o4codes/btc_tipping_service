...
class User(AbstractBaseUser, PermissionsMixin):
    ...
    phone_regex = RegexValidator(regex=r'^\d{9,13}$', message="max of 13 digits allowed.")
    country_code = models.CharField(max_length=4, default='+234')
    phone = models.CharField(validators=[phone_regex], max_length=17, blank=False, null=False) 
